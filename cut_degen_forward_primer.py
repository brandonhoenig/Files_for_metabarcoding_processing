...
fastafile =  "combined_fasta.fna" #This is the input fna file generated from add_qiime_labels.py
adapter =  "ATGATGATGATGATGATGATGATG" #This is the forward primer as a string (degenerate primers can be used)
...
end_defn = 5 #If 5, the primer is removed from the 5' end of the sequence (forward primer). If 3, then it is removed from the 3' end of the sequence (reverse compliment of reverse primer).
adapter_name = 'Forward Primer Name' #This is the name of the adapter that you can put into the output text file.
